...
images = glob.glob('Images/ChArUco Calibration/*.png')
...
f = open('Outputs/ChArUco Calibration/charuco_calibration_1080p.pckl', 'wb')
pickle.dump((cameraMatrix, distCoeffs, rvecs, tvecs), f)
f.close()
    
# Print to console our success
print('Calibration successful. Calibration file used: {}'.format('charuco_calibration_1080p.pckl'))
